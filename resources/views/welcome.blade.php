        ...
        <div class="lg:w-2/4 mx-auto py-8 px-6 bg-white rounded-xl">
            ...
            <div class="mb-6">
                <form class="flex flex-col space-y-4" method="POST" action="/">
                    ...
                    <input type="text" name="title" placeholder="Le titre de la tâche" class="py-3 px-4 bg-gray-100 rounded-xl">
                    <textarea name="description"          
                    placeholder="La description de la tâche" class="py-3 px-4 bg-gray-100 rounded-xl"></textarea>
